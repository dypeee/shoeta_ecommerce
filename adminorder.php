        ...
        if(!empty($status)){
            ...
            if (!empty($status)) {
                ...
                if ($query) {
                    ...
                    echo "<h6 class='text-danger'>Failed to Update</h6>";
                }
                        ...
                        <div class="row">
                            <div class="col-12 mt-5">
                                ...
                                <div class="filter">
                                    ...
                                    <button><a href="adminorder.php" class="text-dark" >All</a></button>
                                    ...
                                    <button><a href="adminorder4.php" class="text-dark" style="text-decoration:none;">Complete</a></button>

        ...
        <div class="row">
            <div class="col-xl-7">
                ...
                <div class="row bg-light m-3 p-2">
                    ...
                    <div class="col-1 d-flex justify-content-end ms-4">
                         <form action="cart.php" method="POST">
                            <?php
                                ...
                                if(ISSET($_POST['checked'])){
                                    ...
                                    $color = $row['color']; 
                                    $checkQuery = mysqli_query($con, "SELECT * FROM cartquantity WHERE userid = '$userid'");
                                    $checkedquery = mysqli_query($con,"INSERT INTO cartquantity (userid, image, productname, brand, price, size, quantity, color)
                                        VALUES ('$userid', '$image', '$productname', '$brand', $price, '$size', $quantity, '$color')");
                                }
                            ?>
                            <div class='d-flex'>
                                <button class="btn btn-success ms-2" name="checked" type="submit">✓</button>
                                <button class="btn btn-danger ms-2" name="unchecked" type="submit">✖</button>
                            </div>
                    ...
                    <div class="col-md-3 col py-4 justify-content-center text-center">
                        <div>
                            <h6><?php echo $row['productname']?></h6>
                            <h6 class="ps-2"><?php echo $row['color']; ?></h6>
                            <div style="margin: auto; display: flex; justify-content: center;">

                ...
                <div class="col-lg-7 p-2">
                    <div style="width: 100%; border: 1px solid; padding: 20px;">
                        <div class="row">
                            ...
                            <!-- change this href-->
                            <div class="col-2">
                                <div class="product "><a href="converse5desc.php?id=<?php echo $id?>&color=Default"><img src="<?php echo $display['image']?>" alt="" width="80%" height="auto" class="productimage"></a></div> <!--Change Image-->
                            </div>
                            <!-- change this href and image color-->
                            <div class="col-2">
                                <div class="product"><a href="converse5desc.php?id=<?php echo $id?>&color=Cheeky Coral"><img src="converse41.png" alt="" width="80%" height="auto" class="productimage"></a></div> <!--Change Image-->
                            </div>
                            <!-- change this  href and image color-->
                            <div class="col-2">
                                <div class="product"><a href="converse5desc.php?id=<?=$id; ?>&color=White"><img src="converse42.png" alt="" width="80%" height="auto" class="productimage"></a></div><!--Change Image-->
                            </div>

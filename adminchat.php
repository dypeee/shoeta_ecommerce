    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-9">
                ...
                include 'connect.php';
                if(ISSET($_POST['chat'])){
                    header("Location: adminchat2.php");
                    exit;
                }
                $query = mysqli_query($con,"SELECT*FROM chatmanager ORDER BY id DESC LIMIT 1");
                $chatdata= mysqli_fetch_assoc($query);
                ...
                <form action="adminchat.php" method="POST">
                    ...
                    <div class="row bg-white m-5 p-3"style="width:90%;">
                        <div class="col-12 text-start d-flex justify-content-between">
                            ...
                            <div><h2 class="fw-bold"><?php echo $name; ?></h2></div>

                            <div><?php  echo date("M d,Y") . "<br>";?></div>

                        </div>
                        <div class="col-12">
                            <h5 class="p-3 text-start"><?php echo $chatdata['userchat']; ?></h5>
                        </div>
                        <input class="btn btn-primary" style="width:30%; margin-left:70%;" type="submit" name="chat" value="Chat">
                    </div>

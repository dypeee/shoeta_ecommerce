                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="customerlist">
                                    ...
                                    <div class="filter">
                                        <button><a href="adminproducts.php" style="text-decoration:underline;">All</a></button>
                                        ...
                                        <button><a href="adminproduct5.php">Vans</a></button>
                                    ...
                                    <div style="overflow-y: scroll; height:700px; background-color:white;" class="border p-2">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:13%;">
                                                <button class="btn btn-success px-4"><a href="adminproductedit.php?id=<?=$id; ?>"style="text-decoration:none;color:white;">Edit</a></button>
